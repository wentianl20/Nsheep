/**
 * Create by pirlo
 * Date: 2022/10/26 2:30 PM
 * Update: 2022/10/26 2:30 PM
 */
...
const useGame = () => {
     ...
     * @param force 强制移除
     */
    const doClickBlock = (block, randomIdx = -1, force = false) => {
    ...
    const doStart = () => {
        ...
        console.log("levelBlocks, randomBlocks, slotArea: ", levelBlocks, randomBlocks, slotArea);
